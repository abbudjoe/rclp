...
| Fleet managers | Dispatch, observe, coordinate, route, and operate robots across a fleet. | Dispatch, routing, scheduling, dashboards, operator workflows, or fleet policy UI. | A lease request and robot-local authority gate that can sit beside a fleet manager for selected high-authority actions. |
